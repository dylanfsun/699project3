...
The likelihood ratio test to compare the two models was conducted using the "anova" function in R, and concordance was generated as part of the standard summary output in the coxph function. A surival curve was also produced using the "ggsurv" function. 
